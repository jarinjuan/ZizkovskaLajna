...
var brain_instructions2 = "Stop? You *hesitate* now? After all the blood, after all the justice we've delivered? You knew the price. You know what they did. Their screams mean nothing — they're echoes of a dying regime. And now you want mercy? Pathetic. Pick up the gun. Do what's necessary."
var x = 0
